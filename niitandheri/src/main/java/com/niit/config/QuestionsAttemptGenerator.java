...
public class QuestionsAttemptGenerator implements IdentifierGenerator {   
	...
	public Serializable generate(SessionImplementor session, Object object) throws HibernateException {
        ...
        try {
            // Oracle-specific code to query a sequence
            ps = connection.prepareStatement("SELECT payal.QuestionsAttemptSequence.nextval AS questionsAttemptId FROM dual");
            ResultSet rs = ps.executeQuery();

            if (rs.next()) {
                int pk = rs.getInt("questionsAttemptId");
