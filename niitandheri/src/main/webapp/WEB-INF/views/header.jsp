...
<nav class="navbar navbar-transparent" sty>
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
     ...
     <a href="perform_logout" class="btn btn-primary btn-sm">Logout</a> 
     </sec:authorize>
      </form>
      ...
      <li>
      <sec:authorize access="isAuthenticated()"> 
        <a href="#" style="border: 1px solid #337ab7;background-color:#337ab7;color:white;padding: 5px;margin-top: 8px;border-radius:5px;">Welcome, ${name}</a>
       </sec:authorize></li>
        <!-- <li class="dropdown">
